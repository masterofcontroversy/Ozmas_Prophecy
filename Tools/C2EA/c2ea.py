...
def addToInstaller(csvList,installername):
    ...
    with open(installername,"w") as myfile:
        ...
        myfile.write('#include "TableDefinitions.txt"\n\n')
...
def main():
    ...
    folder    = os.getcwd()
    installer = "TableInstaller.event"
    ...
    if len(sys.argv) > 1:
        ...
        parser.add_argument('-installer', help = 'output installer event (default: [Folder]/TableInstaller.event)')
        ...
        if args.csv != None:
            ...
            installer = args.installer if args.installer != None else (folder + '/TableInstaller.event')
